...
**AI Engineer / Data Engineer** with a production ML background, focused on building applied GenAI systems using LangChain, LangGraph, RAG, structured outputs, tool calling, human-in-the-loop workflows, and evaluation.
...
> [Live demo](https://YOUR_DEMO_URL) · Uses synthetic customer data and mock policy documents only.
...
| Area | Details |
|---|---|
| **Agentic workflows** | LangGraph multi-node pipelines with conditional routing, retries, approval gates, and human-in-the-loop logic |
...
| **AI safety patterns** | PII masking, approval gates, audit trails, manual review fallback, and prevention of unsupported action claims |
...
- Building applied GenAI systems with LangChain, LangGraph, RAG, and LangSmith
- Designing safe AI workflows with structured outputs, tool calling, approval gates, and evaluation
